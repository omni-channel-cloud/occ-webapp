/**
 * OCC配置文件 更多说明文档请看 https://github.com/iuap-design/ucf-web/blob/master/packages/ucf-scripts/README.md
...
module.exports = (env, argv) => {
    ...
    return {
        ...
        global_env: {
            GROBAL_HTTP_CTX: isBuild ? JSON.stringify("/occ-webapp") : JSON.stringify("/mock/936"),
        },
        // 别名配置
        alias: {
            components: path.resolve(__dirname, 'occ-common/src/components/'),
            utils: path.resolve(__dirname, 'occ-common/src/utils/'),
            static: path.resolve(__dirname, 'occ-common/src/static/'),
            styles: path.resolve(__dirname, 'occ-common/src/styles/'),
